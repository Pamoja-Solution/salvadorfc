<div>
    <div class="p-6 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 dark:text-white rounded-lg shadow-lg border-t-4 border-white">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
            ...
            <!-- Filtre -->
            <select wire:model.live="selectedType" class="p-3 rounded-lg dark:bg-gray-800/60 border dark:border-gray-700 dark:text-white focus:ring-2 focus:ring-white w-full sm:w-auto">
