...
<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-700 antialiased">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
        <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            ...
            <div class="flex space-x-4 text-sm text-gray-600 rounded rounded-6 border-b border-t border-red-600 p-2">
                ...
                <button 
                  onclick="navigator.clipboard.writeText('https://www.fcbarcelona.fr/fr/football/equipe-premiere/actualites/4226357/barca--real-sociedad-leaders-en-solitaire-4-0')" 
