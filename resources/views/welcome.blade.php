...
<body class="backdrop-blur-md bg-opacity-70 bg-gray-900 text-white ">
            ...
            <button data-collapse-toggle="navbar-sticky" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-cyan-400 rounded-lg md:hidden hover:bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-cyan-500">
              ...
              <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-lg md:space-x-4 rtl:space-x-reverse md:flex-row md:mt-0">
                  ...
                  <li>
                    <a href="{ {route('user.accueil')}}" class="block py-2 px-3 text-cyan-400 rounded hover:bg-gray-800/50 hover:text-cyan-300 transition-colors duration-300">Résulatats</a>
                  </li>
                  <li>
    ...
    <div id="default-carousel" class="relative w-full z-40" data-carousel="slide">
        <!-- Carousel wrapper -->
        <div class="relative h-96 overflow-hidden rounded-lg md:h-196">
            <!-- Item 1 -->
            <div class="hidden duration-6000 ease-in-out" data-carousel-item>
                <img src="{{ asset('img/1740169349422.jpg') }}" class="absolute   object-cover block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            ...
            <!-- Item 2 -->
            <div class="hidden duration-6000 ease-in-out" data-carousel-item>
                <img src="{{ asset('img/1740169356313.jpg') }}" class="absolute    block w-full object-cover -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                <div class="absolute inset-0 flex items-center justify-center text-center animate-fadeIn">
                    <div>
            ...
            <!-- Item 3 -->
            <div class="hidden duration-6000 ease-in-out" data-carousel-item>
                <img src="{{ asset('img/1740169417088.jpg') }}" class="absolute  object-cover  block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                <div class="absolute inset-0 flex items-center justify-center text-center animate-fadeIn">
                    <div>
            ...
            <!-- Item 4 -->
            <div class="hidden duration-6000 ease-in-out" data-carousel-item>
                <img src="{{ asset('img/1740169523721.jpg') }}" class="absolute  object-cover  block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                <div class="absolute inset-0 flex items-center justify-center text-center animate-fadeIn">
                    <div>
            ...
            <!-- Item 5 -->
            <div class="hidden duration-6000 ease-in-out" data-carousel-item>
                <img src="{{ asset('img/1740169797146.jpg') }}" class="absolute  object-cover  block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                <div class="absolute inset-0 flex items-center justify-center text-center animate-fadeIn">
                    <div>
    ...
    <section id="about" class="py-20 bg-gray-800">
        <div class="container mx-auto px-4">
            ...
            <p class="text-lg text-center text-gray-300 max-w-2xl mx-auto">
                Découvrez l'histoire et les valeurs de notre club. Nous sommes une famille unie, passionnée par notre sport et notre communauté.
            </p>
        </div>
    </section>
